...
//                   className="mt-6 px-6 py-3 bg-[#0e4a22] text-white rounded-md text-sm sm:text-base md:text-lg font-medium hover:bg-[#15bd52] transition"
//                 >
//                   Start Quiz
//                 </button>
//                 <button
...
//       <button
//                   onClick={() => router.push("/startquiz")}
//                   className="bg-[#0e4a22] text-white px-6 py-3 rounded-md font-medium shadow hover:bg-[#15bd52] transition"
//                 >
//                   Start Quiz
//                 </button>
  ...
  return (
    <main>
      ...
      {/* <section className="w-full py-16 bg-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="mt-3 text-gray-600">
            Start your journey on SkillCircle based on what you want to do.
          </p>

          <div className="mt-10 flex flex-col sm:flex-row gap-6 justify-center">
            <button
              onClick={() => router.push("/")}
              className="px-10 py-4 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700 transition shadow-md"
            >
              Find Talent
            </button>
            ...
            <button
              onClick={() => router.push("/")}
              className="px-10 py-4 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition shadow-md"
            >
              Find Work 
            </button>
          </div>
      ...
      {/* <section className="w-full py-10 bg-white">
        <div>
          <h1 className="text-center" > made on skillcirclee</h1>
        </div>
        </section> */}
